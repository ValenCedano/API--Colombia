...
//       // Procesar los datos obtenidos
//       console.log(data);
//       // Generar el HTML con estilos para mostrar el JSON
//       let html = `<p class="json-separator">{</p><br/>`;
//       for (const key in data) {
//         if (data.hasOwnProperty(key)) {
//           html += `<span class="json-key">"${key}"</span>: <span class="json-value">${JSON.stringify(data[key])}</span>, <br/>`;
//         }
//       }
//       html += `<p class="json-separator">}</p>`;
